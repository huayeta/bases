    ...
    render(){
        ...
        return(
            <tr>
                ...
                <td className="tac"><Input type="text" className="u-txt" style={{'width':'80%'}} name={'arg[sales]['+idArr.join('|')+'][price]'} value={val.price} /></td>
                <td className="tac"><Input type="text" className="u-txt" style={{'width':'80%'}} name={'arg[sales]['+idArr.join('|')+'][cost]'} value={val.cost}  /></td>
                <td className="tac"><Input type="text" className="u-txt" style={{'width':'80%'}} name={'arg[sales]['+idArr.join('|')+'][stock]'} value={val.stock} /></td>
                <td className="tac">
                    <input type="hidden" name={'arg[sales]['+idArr.join('|')+'][title]'} value={title}  />
                    <input type="hidden" name={'arg[sales]['+idArr.join('|')+'][advertisement]'} value={advertisement}  />
                    ...
                    <input type="hidden" name={'arg[sales]['+idArr.join('|')+'][video]'} value={val.video}  />
                    ...
                    <DialogGet className="u-btn" url="/js/src/product/routes/editor/index.htm" data={{defaultValue:val,sale:sale,config:{title:title,advertisement:advertisement}}} callback={this.handleSpicEditor.bind(this)}>编辑</DialogGet>
                </td>
            </tr>
        )
    }
